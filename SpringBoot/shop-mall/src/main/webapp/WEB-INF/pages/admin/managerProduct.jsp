...
<body>
	...
	<div class="col-md-9 animated bounce">
		...
		<div class="form-group form-inline">
			<label for="sel1">THÊM MỚI SẢN PHẨM (THEO DANH MỤC): </label> <select
				id="categoryDropdown" class="form-control">
		...
		<form class="form-inline" id="searchForm" name="searchObject">
			...
			<div class="form-group">
				<select class="form-control" name="hangSXId" id=manufacturer>
					<option value="">Tất cả hãng sản xuất</option>
					<c:forEach var="brand" items="${listbrand }">
						<option value="${brand.id}">${brand.nameManufacturer}</option>
					</c:forEach>
				</select>
			</div>

			<div class="form-group">
				<select class="form-control" name="unitPrice" id="price">
			...
			&nbsp;&nbsp;
			<button type="button" class="btn btn-primary" id="btnDuyetProduct">Duyệt
				sản phẩm</button>
		</form>
	...
	<div class="row col-md-6">
		<form id="MassageForm" class="MassageForm">
			<div class="modal fade massageModal" tabindex="-1" role="dialog"
						...
						<div class="modal-body">
							<div class="row">
								<div>
									<input type="hidden" class="form-control" name="categoryId"
										id="idCategoryMassage">
								</div>
								<div>
									<input type="hidden" class="form-control" name="id"
										id="idProductMassage" readonly>
								</div>
								...
								<div class="form-group col-md-5">
									<label for="inputPassword4">Đơn giá</label> <input
										type="number" class="form-control" name="unitPrice" min="0"
										value="0" id="test">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<textarea class="form-control" name="genaralInfomation"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								...
								<div>
									<input type="hidden" class="form-control" name="id"
										id="idProductKhac" readonly="true">
								</div>
								<div class="form-group col-md-12">
									<label for="inputPassword4">Tên sản phẩm</label> <input
										type="text" class="form-control" name="nameProduct">
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputState">Hãng Sản Xuất</label> <select
										...
										<c:forEach var="brand" items="${listBrand }">
											<option value="${brand.id }">${brand.nameManufacturer}
											</option>
										</c:forEach>
									</select>
								</div>
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<textarea class="form-control" id="inputPassword4"
										placeholder="" rows="2" name="genaralInfomation"></textarea>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									...
									<div class="container-fliud">
										<div class="wrapper row">
											...
											<div class="details col-md-6" style="font-size: 16px">
												...
												<p class="thietKe"></p>
												<p class="genaralInfomation"></p>
												<p class="baoHanh"></p>
												<p class="unitPrice"></p>
												<p class="donViKho"></p>
												<p class="sellingUnit"></p>
											</div>
										</div>
									</div>
								</div>
