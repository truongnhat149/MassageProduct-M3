...
<style type="text/css">
td, #contentContact, .contentContact, #noiDungTraLoi {
...
<body>
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="name">Email liên hệ:</label> <input type="text"
										name="emailContact" id="emailContact" style="border: 0"
										readonly="readonly" />
								</div>

								<div class="form-group">
									<label for="name">Nội dung liên hệ:</label>
									<textarea class="form-control" name="contentContact"
	...
	<script src="<c:url value='/js/contactAjax.js'/>"></script>
</body>
</html>