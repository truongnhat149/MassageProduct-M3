...
<body>
	...
	<div class="col-md-9 animated bounce">
		...
		<form class="form-inline" id="searchForm" name="searchObject">
			...
			&nbsp;&nbsp; &nbsp;&nbsp;
			<button type="button" class="btn btn-primary" id="btnDuyetOrder">Duyệt
				Đơn</button>
				...
				<div class="modal-dialog" role="document" style="width: 700px;">
					<div class="modal-content">
						<div class="modal-header">
							<p class="h4 modal-title" id="maOrder"></p>
								...
								<div class="form-group">
									Chọn shipper cho đơn hàng: <select class="form-control"
										...
										<c:forEach var="shipper" items="${allShipper }">
											<option value="${shipper.email }">${shipper.fullname }
												(${fn:length(shipper.listOrder)})</option>
										</c:forEach>
									</select>
								</div>
				...
				<div class="modal fade" id="capNhatTrangThaiModal" tabindex="-1"
					...
					<div class="modal-dialog " role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="form-group">
									<input type="hidden" id="idOrderXacNhan" value="">
								</div>
								<div class="form-group">
									<div class="col-md-12">
										<table class="table chiTietTable"
