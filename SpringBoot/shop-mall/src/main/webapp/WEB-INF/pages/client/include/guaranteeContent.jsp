...
<div class ="container">
	<div class="row">
		...
		<div class="col-lg-10" class="pull-center">
			...
			<b>2. SẢN PHẨM ÁP DỤNG:</b> Máy tính nguyên chiếc (Massage, máy tính lắp ráp, máy đồng bộ)</p>
			<br>
			...
			<p>
			Khách hàng là các doanh nghiệp, tổ chức (không áp dụng cho khách hàng cá nhân) khi mua máy tính nguyên chiếc (bao gồm: Massage, máy tính lắp ráp, máy đồng bộ) tại Công Ty Máy Tính Hà Nội được tặng 1 THẺ BẢO HÀNH VÀNG trị giá 500.000 đ (bảo hành tại nơi sử dụng) cho mỗi sản phẩm.
			</p>
			<br>
			<p>
