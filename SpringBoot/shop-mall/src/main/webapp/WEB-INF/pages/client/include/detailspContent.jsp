...
<link rel="stylesheet" href="Frontend/css/detailsp.css">
	...
	$(document).ready(function() { 
	  	var priceConvert = accounting.formatMoney(${sp.getunitPrice()})+' VND';
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="/shopmall/img/${sp.getId()}.png" /></div>
						</div>		
					</div>
					<div class="details col-md-6">
						<p style="display:none" id="spid">${sp.getId()}</p>
						<h2 class="product-title">${sp.getnameProduct()}</h2>
						...
						<p class="product-description">Hãng sản xuất: ${sp.hangSanXuat.nameManufacturer}</p>
						<p class="product-description"><span class="important">THÔNG TIN CHUNG:</span> ${sp.getgenaralInfomation()}</p>
