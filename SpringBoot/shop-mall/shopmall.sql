CREATE DATABASE  IF NOT EXISTS `shop-online` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `shop-online`;
...
CREATE TABLE `cart_index` (
  ...
  `cart_code` bigint(20) DEFAULT NULL, -- mã giỏ hàng
  `product_code` bigint(20) DEFAULT NULL, -- mã sp
  PRIMARY KEY (`id`),
...
LOCK TABLES `cart_index` WRITE;
/*!40000 ALTER TABLE `cart_index` DISABLE KEYS */;
INSERT INTO `cart_index` VALUES (10,7,1,64),(11,1,1,54),(12,1,1,60),(13,2,1,56),(14,1,1,62),(15,1,2,88),(16,1,2,85);
/*!40000 ALTER TABLE `cart_index` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `category` VALUES (1,'Massge'),(2,'Massge BC & Massge Love'),(3,' Massge Love & Relax');
...
CREATE TABLE `order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `receiving_address` varchar(255) DEFAULT NULL, -- địa chỉ nhận
  `note` varchar(255) DEFAULT NULL,
  `fullname_receive` varchar(255) DEFAULT NULL, -- họ và tên người nhận
  `order_date` datetime DEFAULT NULL,
  `delivery_date` datetime DEFAULT NULL, -- ngày giao hàng
  `date_of_receipt` datetime DEFAULT NULL, -- ngày nhận hàng
  `phone_receipt` varchar(255) DEFAULT NULL, -- sdt nhận
  `status` varchar(255) DEFAULT NULL,
  `orderer_code` bigint(20) DEFAULT NULL, -- mã người đặt
  `shipper_code` bigint(20) DEFAULT NULL, -- mã shipper
  PRIMARY KEY (`id`),
...
CREATE TABLE `cart` (
  ...
  `user_code` bigint(20) DEFAULT NULL, -- mã người dùng
  PRIMARY KEY (`id`),
...
CREATE TABLE `manufacturer` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `manufacturer_name` varchar(255) DEFAULT NULL, -- hãng sản xuất
  PRIMARY KEY (`id`)
...
INSERT INTO `manufacturer` VALUES (2,'US'),(3,'Japan'),(4,'VietNam');
...
CREATE TABLE `contact` (
  ...
  `status` varchar(255) DEFAULT NULL,
  `respondent_code` bigint(20) DEFAULT NULL, -- mã ng trl
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES (1,NULL,'admin@gmail.com','LPNT','admin','123456789'),(2,NULL,'member@gmail.com',NULL,'member',NULL),(3,NULL,'shipper@gmail.com',NULL,'shipper',NULL);
...
CREATE TABLE `user_role` (
  `user_code` bigint(20) NOT NULL, -- mã người dùng
  `role_code` bigint(20) NOT NULL, -- mã vai trò
...
CREATE TABLE `product` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `unit_price` bigint(20) NOT NULL,
  `selling_unit` int(11) NOT NULL, -- đơn vị bán
  `warehouse_unit` int(11) NOT NULL, -- đơn vị kho
  `name_product` varchar(255) DEFAULT NULL,
  `design` varchar(255) DEFAULT NULL,
  `insurance_infomation` varchar(255) DEFAULT NULL, -- thông tin bảo hành
  `genaralInfomation` varchar(255) DEFAULT NULL,
  `category_code` bigint(20) DEFAULT NULL, -- mã danh mục
  `manufacturer_code` bigint(20) DEFAULT NULL, -- mã sản xuất
  PRIMARY KEY (`id`),
