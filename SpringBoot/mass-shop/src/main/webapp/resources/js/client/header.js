$(document).ready(function(){
	...
	function ajaxGet2(){
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/massageshop/api/danh-muc/allForReal",
			success: function(result){
				$.each(result, function(i, danhmuc){
					var content = '<li><a href="/massageshop/store?brand='+danhmuc.tenDanhMuc+'"><span style=" font-size: 16px; font-weight: 900; ">'+danhmuc.tenDanhMuc+'</span></a></li>';
